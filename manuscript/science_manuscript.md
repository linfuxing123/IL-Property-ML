...
The assembled database (`data/il_props.db`), model-ready subsets (`workspace/matmodel/data/`), all modeling and figure scripts (`workspace/matmodel/`), and this manuscript are available in the project workspace. Public data sources: ILest (14), iolitech (15), and ILThermo (16). Code is provided as Python scripts with pinned dependencies; no commercial software is required.
