...
3. **A benchmark.** The dataset, split files, a multi-model leaderboard on identical folds, and one-command reproducibility are released openly (GitHub release v2.2.0; Zenodo DOI 10.5281/zenodo.21996950), so every number is auditable and extensible.
